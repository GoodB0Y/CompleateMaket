...
let menuButtonActive = document.querySelector('.mobile-menu__button');
let mobileOnlyMenu = document.querySelector('.navigation__mobile');
let containerBody = document.querySelector('.container');

/* button mobile menu close */
let crossButtonInMenu = document.querySelector('.info-button.info-button--close');

/* callback form info */
let formPhoneButton = document.querySelectorAll('.tel-js');
let callBackForm = document.querySelector('.callback.side-up');

/* feedback form info */
let formChatButton = document.querySelectorAll('.contact-js');
let feedbackBackForm = document.querySelector('.feedback.side-up');

/* all close buttons */
let closeButtons = document.querySelectorAll('.info-button.info-button--close');
